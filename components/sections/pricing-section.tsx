    ...
    categories: [
      {
        ...
        items: [
          "내 계정 상황에 맞는 방향을 한 번에 정확히 잡고 싶은 사람",
          "시행착오 줄이고, 바로 실행 가능한 전략을 받고 싶은 사람",
          "현재 상태를 진단받고 맞춤형으로 구조를 설계하고 싶은 사람",
          "혼자 고민하는 시간을 줄이고 빠르게 방향을 정리하고 싶은 사람",
        ],
      },
      {
        title: "1대1 컨설팅 구성",
        items: [
          "1대1 집중 컨설팅 (50분)",
          "한 달간 사용 가능한 코칭권 3회 제공 (질문 가이드 제공)",
          "30일 콘텐츠 플랜 제공",
          "와이엘지 미디어 스페셜 키트 할인권 제공",
        ],
      },
      {
        title: "컨설팅 세부 내용",
        items: [
          "계정 상태 진단 (포지셔닝 / 타겟 / 메시지)",
          "콘텐츠 구조 설계 (유입 / 관계 / 전환)",
          "터지는 포맷 및 방향 제시",
          "프로필 / 링크 / CTA 구조 점검",
          "수익화 흐름 설계 (DM / 상품 / 전환 구조)",
        ],
        note: "※ 모든 항목이 동일하게 적용되는 것이 아니라,\n계정 상태와 목표에 맞춰 가장 필요한 부분부터 집중적으로 진행됩니다.",
      },
      {
        title: "이 세가지가 명확해집니다.",
        items: [
                      ...
                      <div className="space-y-8">
                        {(plan.categories as any[]).map((category, cIdx) => (
                          <div key={cIdx} className="space-y-3">
                            ...
                            {category.note && (
                              <p className="mt-2 text-xs leading-relaxed opacity-60 whitespace-pre-wrap">
                                {category.note}
                              </p>
                            )}
                          </div>
